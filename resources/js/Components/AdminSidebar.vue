    ...
    <div class="flex flex-col w-full sm:w-1/4">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="flex flex-col" v-if="openAdmins">
                ...
                <Link :href="route('admin.users.index')" class="text-right capitalize border-t w-full px-6 py-2" :class="route().current('admin.users.*') ? 'text-gray-50 bg-gray-500':'hover:text-gray-50 hover:bg-gray-500'">Users</Link>
            </div>
